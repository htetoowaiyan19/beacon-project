# ဒီ script က LoRA adapter သုံးပြီး trained model ကို test လုပ်ရာတွင်သုံးပါတယ်၊ မိမိမှာ train လုပ်ထားသော model မရှိပါက အသုံးမပြုနိုင်ပါ။
